...
Ao trabalhar com números decimais em C++, usamos o tipo de dados double, que pode armazenar números com pontos decimais. Os mesmos operadores aritméticos (+, -, *, /) funcionam com doubles da mesma forma que com inteiros:
